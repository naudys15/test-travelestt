...
class StreetMarketsTranslations extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('streetmarkettranslation', function (Blueprint $table) {
            $table->increments('id')->comment('id de la traducción del mercadillo');
    ...
    {
        Schema::dropIfExists('streetmarkettranslation');
    }
}
