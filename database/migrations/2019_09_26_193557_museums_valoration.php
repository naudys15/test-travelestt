...
class MuseumsValoration extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('museumvaloration', function (Blueprint $table) {
            $table->increments('id')->comment('id de la valoracion del museo');
            $table->integer('id')->unsigned()->comment('id del museo');
            $table->foreign('id')->references('id')->on('museum');
    ...
    {
        Schema::dropIfExists('museumvaloration');
    }
}
