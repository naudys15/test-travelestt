...
class PointsOfInterest extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pointofinterest', function (Blueprint $table) {
            $table->increments('id')->comment('id del punto de interés');
            ...
            $table->float('duration_value', 5, 2)->comment('duración del punto de interés')->nullable();
