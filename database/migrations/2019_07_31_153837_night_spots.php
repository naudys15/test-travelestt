...
class NightSpots extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('nightspot', function (Blueprint $table) {
            $table->increments('id')->comment('id del sitio nocturno');
            ...
            $table->string('phonenumber', 25)->collation('utf8_general_ci')->comment('teléfono')->nullable();
            $table->float('duration_value', 5, 2)->comment('duración del sitio nocturno')->nullable();
