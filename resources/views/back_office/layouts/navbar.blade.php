            ...
            <div id="navbar-container" class="boxed">
                ...
                <div class="navbar-header">
                    <a href="index.html" class="navbar-brand">
                        <img src="{{ asset('assets/images/logo1.png') }}" alt="Nifty Logo" class="brand-icon">
                    ...
                    <ul class="nav navbar-top-links">
                        <li class="dropdown">
                            <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                                @if(app()->getLocale() == 'es')
                                    {{ __('language.es') }} <i class="dropdown-caret"></i>
                                @elseif(app()->getLocale() == 'en')
                                    {{ __('language.en') }} <i class="dropdown-caret"></i>
                                @elseif(app()->getLocale() == 'fr')
                                    {{ __('language.fr') }} <i class="dropdown-caret"></i>
                                @endif
                            </a>
                                    ...
                                    foreach ($available_languages as $lang) {
                                        if (isset($key_for_translation)) {
                                            if ($lang != app()->getLocale()) {
                                                ...
                                                if (empty($segment_4)) {
                                                    ?>
                                                    <li><a href="{{ url($lang.'/'.__("routes.panel", [], $lang).'/'.$language) }}">{{ __("language.$lang") }}</a></li>
                                                    <?php
                                                } else {
                                                    if (isset($key_for_translation_2)) {
                                                        $language_2 = __("routes.$key_for_translation_2", [], $lang);
                                                        if (empty($segment_6)) {
                                                            ?>
                                                            <li><a href="{{ url($lang.'/'.__("routes.panel", [], $lang).'/'.$language.'/'.$segment_4.'/'.$language_2) }}">{{ __("language.$lang") }}</a></li>
                                                            <?php
                                                        } else {
                                                            ?>
                                                            <li><a href="{{ url($lang.'/'.__("routes.panel", [], $lang).'/'.$language.'/'.$segment_4.'/'.$language_2.'/'.$segment_6) }}">{{ __("language.$lang") }}</a></li>
                                                            <?php
                                                        }
                                                    } else {
                                                        ?>
                                                        <li><a href="{{ url($lang.'/'.__("routes.panel", [], $lang).'/'.$language.'/'.$segment_4) }}">{{ __("language.$lang") }}</a></li>
                                                        <?php
                                                    }
                                                }
                                            }
                                            ...
                                            if ($lang != app()->getLocale()) {
                                                ?>
                                                <li><a href="{{ url($lang.'/'.__("routes.panel", [], $lang)) }}">{{ __("language.$lang") }}</a></li>
                                                <?php
                                            }
                                        }
                                    }
                        ...
                        <li id="dropdown-user" class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right panel-default">
                                <ul class="head-list">
                                    ...
                                    <li>
                                        <a id="logout" href="#"><i class="demo-pli-unlock icon-lg icon-fw"></i> Logout</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
