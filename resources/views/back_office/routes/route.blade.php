            ...
            <div class="col-lg-12">
                <div class="panel">
                    <div class="panel-body">
                        <div class="form-group" id="ubication"></div>
                    ...
                    <h4 class="mar-btm">{{ __('language.route') }}</h4>
                    ...
                    <!-- <div class="form-group">
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                <input type="number" id="duration_value" class="form-control" placeholder="<?php //echo _l('time'); ?>" name="duration_value" value="<?php if (isset($route)) {  if (is_array($route)) { echo $route['duration']['value']; }} ?>">
                                </div>
                                <div class="col-sm-8">
                                <?php
                                    /*if (isset($route)) {
                                    if (is_array($route)) {
                                        echo form_dropdown('duration_unit', ['minutes' => _l('minutes'), 'hours' => _l('hours')], $route['duration']['unit'], ['id'=>'duration_unit', 'class'=>'form-control']);
                                    } else {
