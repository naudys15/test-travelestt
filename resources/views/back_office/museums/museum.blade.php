        ...
        <div class="row" id="setLanguage" onclick="setLanguage('spanish')">
            ...
            <div class="col-lg-12">
                <div class="panel">
                    ...
                    <h4 class="mar-btm">{{ __('language.museum') }}</h4>
                    ...
                    <!-- <div class="form-group">
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                <input type="number" id="duration_value" class="form-control" placeholder="<?php //echo _l('time'); ?>" name="duration_value" value="<?php if (isset($museum)) {  if (is_array($museum)) { echo $museum['duration']['value']; }} ?>">
                                </div>
                                <div class="col-sm-8">
                                <?php
                                    /*if (isset($museum)) {
                                    if (is_array($museum)) {
                                        echo form_dropdown('duration_unit', ['minutes' => _l('minutes'), 'hours' => _l('hours')], $museum['duration']['unit'], ['id'=>'duration_unit', 'class'=>'form-control']);
                                    } else {
