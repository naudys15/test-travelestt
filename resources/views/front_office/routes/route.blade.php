                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <div class="title d-flex justify-content-center justify-content-md-start align-items-center mb-3 flex-wrap">
                            <i class="fas fa-route fa-2x mr-3 text-aqua"></i>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5">
                                ...
                                <div class="pendientes">
                                    <h6 class="font-weight-bold mb-4">Pendientes</h6>
                                    <div class="row arrows d-flex justify-content-around mb-2">
                                        <i class="fas fa-arrow-up"></i>
                                        <i class="fas fa-arrow-up"></i>
                                        <i class="fas fa-arrow-up"></i>
                                        <i class="fas fa-arrow-down"></i>
                                    </div>
                                    <div class="row text-first d-flex justify-content-around">
                                        <p class="text-secondary mb-1">100 m</p>
                                        <p class="text-secondary mb-1">100 m</p>
                                        <p class="text-secondary mb-1">100 m</p>
                                        <p class="text-secondary mb-1">100 m</p>
                                    </div>
                                    <div class="row text-second d-flex justify-content-around">
                                        <small class="text-secondary">Subida</small>
                                        <small class="text-secondary">Bajada</small>
                                        <small class="text-secondary">+ Alto</small>
                                        <small class="text-secondary">+ Bajo</small>
                                    </div>    
                                </div>
                            <h6 class="font-weight-bold mb-4">{{ __('language.from') }} <span id="inicio_ruta"></span></h6>
                            <!-- Timeline -->
                            <ul class="timeline">
                                {{-- <li class="timeline-item rounded ml-3 p-3">
                                    ...
                                    <p class="text-small mt-2 font-weight-light">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                                </li>
                                <li class="timeline-item rounded ml-3 p-3">
                                    <div class="timeline-arrow"></div>
