            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <div class="title d-flex justify-content-center justify-content-md-start align-items-center mb-3 flex-wrap">
                        <i class="fas fa-umbrella-beach fa-2x mr-3 text-aqua"></i>
                        ...
                        <div class="col-lg-5">
                            ...
                            <div class="row">
                                <div class="col-12 info mb-5">
                                    <h6 class="font-weight-bold mb-4">{{ __('language.sand_type') }}</h6>
                                    <div class="row">
                                        <div class="col-lg-12">
                                          <div class="d-flex">
                                            <i class="fas fa-umbrella-beach fa-2x mr-3 text-aqua"></i><p id="place_sand" class="text-secondary mb-0 align-self-center"></p>
                                          </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 info mb-3">
                                    <h6 class="font-weight-bold mb-4">{{ __('language.extras') }}</h6>
                                    <div class="row">
                                        <div id="place_extras" class="col-lg-12">
                                          <div id ="place_extras_content" class="row">
                                            {{-- <div class="col-md-4 col-lg-3">
                                              <div class="text-center">
                                                <i class="fas fa-shoe-prints fa-2x text-aqua"></i>
                                                <p id="place_extra" class="text-secondary mb-0 align-self-center">Lava pies</p>
                                              </div>
                                            </div>
                                            <div class="col-md-4 col-lg-3">
                                              <div class="text-center">
                                                <i class="fab fa-accessible-icon fa-2x text-aqua"></i>
                                                <p id="place_extra" class="text-secondary mb-0 align-self-center">Acceso discapacitados</p>
                                              </div>
                                            </div>
                                            <div class="col-md-4 col-lg-3">
                                              <div class="text-center">
                                                <i class="fas fa-shower fa-2x text-aqua"></i>
                                                <p id="place_extra" class="text-secondary mb-0 align-self-center">Duchas</p>
                                              </div>
                                            </div>
                                            <div class="col-md-4 col-lg-3">
                                              <div class="text-center">
                                                <i class="fas fa-life-ring fa-2x text-aqua"></i>
                                                <p id="place_extra" class="text-secondary mb-0 align-self-center">Socorristas</p>
                                              </div>
                                            </div>
                                            <div class="col-md-4 col-lg-3">
                                              <div class="text-center">
                                                <i class="fas fa-swimmer fa-2x text-aqua"></i>
                                                <p id="place_extra" class="text-secondary mb-0 align-self-center">Deportes acuáticos</p>
                                              </div>
                                            </div>
                                            <div class="col-md-4 col-lg-3">
                                              <div class="text-center">
                                                <i class="fas fa-store fa-2x text-aqua"></i>
                                                <p id="place_extra" class="text-secondary mb-0 align-self-center">Chiringuitos</p>
                                              </div>
                                            </div> --}}
                                          </div>
                                        </div>
