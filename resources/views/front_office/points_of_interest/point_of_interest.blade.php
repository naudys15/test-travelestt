    ...
    @section('content')
        ...
        <input id="slug_place" type="hidden" name="slug_place" value="">
            <div class="container">
                <div class="row">
                    <!-- TITULO -->
                    <div class="col-12">
                        ...
                        <div class="title d-flex justify-content-center justify-content-md-start align-items-center mb-3 flex-wrap">
                            <i class="fas fa-archway fa-2x mr-3 text-aqua"></i>
                        ...
                        <div class="save d-flex justify-content-end align-items-center">
                            <div class="col-md-3 d-flex justify-content-end align-items-center">
                                <button type="button" data-entity="coast" data-id="9999"class="btn btn-outline-dark rounded-pill btn-block btn_guardar_a_mi_viaje text-secondary"><i class="far fa-bookmark mr-3"></i>Agregar a mis favoritos</button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="destinos">
                            <div class="row">
                                <?php
                                if (isset($coast['related_places'])) {
                                    foreach ($coast['related_places'] as $related_place) {
                                    ?>
                                        <!-- ruta -->
                                        <div class="col-sm-6 col-md-4 destino mb-3">
                                            <div class="destino_img position-relative">
                                                ...
                                                <a href="#">
                                                    ...
                                                    <?php
                                                    if (isset($related_place['images']) && $related_place['images'] != '') {
                                                    ?>
                                                        <div class="bg_img" style="height:200px; background-image: url('')">
                                                        </div>
                                                    <?php
                                                    } else {
                                                    ?>
                                                    ...
                                                    <div class="destino_info mt-1 d-flex p-3">
                                                        <div>
                                                            <p class="font-weight-bold mb-0"><?=$related_place['name']?></p>
                                                            <div class="text-secondary"><small><span class="calificacion mr-1"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></span>56 Opiniones</small></div>
                                                        </div>
                                                    </div>
                                                    <div class="destino_resume position-absolute text-white p-3 d-flex flex-column justify-content-end">
                                                        <p class="font-weight-bold mb-1"><?=$related_place['name']?></p>
                                                        <div class="text-secondary"><small><span class="calificacion mr-1"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></span>56 Opiniones</small></div>
                                                        <p class="destino_descripcion mt-1"><?=$related_place['long_description']?></p>
                                                    </div>
                                                </a>
                                            </div>
                                        </div>
