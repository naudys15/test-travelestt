                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <div class="title d-flex justify-content-center justify-content-md-start align-items-center mb-3 flex-wrap">
                            <i class="fas fa-landmark fa-2x mr-3 text-aqua"></i>
                            ...
                            <div class="col-lg-5">
                                ...
                                <div class="row">
                                    <div class="col-12 info mb-5">
                                        <h6 class="font-weight-bold mb-4">{{ __('language.museum_type') }}</h6>
                                        <div class="row">
                                            <div class="col-lg-12">
                                            <div class="d-flex">
                                                <i class="fas fa-landmark fa-2x mr-3 text-aqua"></i><p id="place_type" class="text-secondary mb-0 align-self-center"></p>
                                            </div>
                                            </div>
                                        </div>
                                    </div>
