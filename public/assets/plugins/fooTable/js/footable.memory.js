 ...
 *   });
 *
 * Based on FooTable Plugin Bookmarkable by Amy Farrell (http://github.com/akf)
 *
 * Created by Chris Laskey (http://github.com/chrislaskey)
 */
    ...
    var set_storage_engine = (function(){
        ...
        try {
            ...
            try {
                ...
                throw new Error('FooTable Memory requires either localStorage or cookie support via jQuery $.cookie plugin (http://github.com/carhartl/jquery-cookie)');
            }
        }
    })($);
