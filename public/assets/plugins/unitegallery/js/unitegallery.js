...
function UGThumbsGeneral(){
	...
	var g_options = {
			...
			thumb_loader: true,					//show thumb loader while loading the thumb
			 ...
			 for(var i=0;i<numItems;i++){
				...
				var thumbStyle = "style='z-index:"+zIndex+";'";
				 ...
				 if(g_temp.customThumbs == false){
					 ...
					 if(g_options.thumb_loader == true && objImage){
...
function UGTileDesign(){
	...
	var g_options = {
			...
			tile_link_icon: false,				//show link icon (if the tile has a link). In case of tile_as_link this option not enabled
	...
	function setHtmlThumb(objThumbWrapper, objItem){
		...
		if(g_options.tile_enable_icons){
			...
			//add link icon
			if(objItem.link && g_options.tile_link_icon == true || g_options.tile_as_link == true){
...
function UGSoundCloudAPI(){
	...
	function putSoundActually(divID, trackID, width, height, isAutoplay){
		...
		url += "&amp;buying=false&amp;liking=false&amp;download=false&amp;sharing=false&amp;artwork=true&comments=false&amp;playcount=true&amp;user=false&amp;hide_related=true&amp;visual=true&amp;start_track=0&amp;callback=true";
...
function UGYoutubeAPI(){
	...
	this.loadAPI = function(){
		...
		g_ugFunctions.loadJs("http://www.youtube.com/player_api", false);
	...
	this.getVideoImages = function(videoID){
		var obj = {};
		obj.preview = "http://i.ytimg.com/vi/"+videoID+"/sddefault.jpg";
		obj.thumb = "http://i.ytimg.com/vi/"+videoID+"/default.jpg";
		return(obj);
	}
...
function UGLightbox(){
	...
	var g_options = {
			...
			lightbox_textpanel: true,					//show the text panel
			...
			lightbox_numbers: true,					//show numbers on the right side
	...
	function initLightbox(gallery, customOptions){
		...
		if(g_options.lightbox_textpanel == true){
	...
	function modifyOptions(){
		...
		if(g_temp.isCompact == true && g_options.lightbox_textpanel == true){
		...
		if(g_options.lightbox_textpanel == false){
