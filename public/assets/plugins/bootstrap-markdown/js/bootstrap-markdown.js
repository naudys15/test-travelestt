...
(function(factory){
  ...
  var Markdown = function (element, options) {
    ...
    // @see : http://github.com/toopay/bootstrap-markdown/issues/109
  ...
  , showPreview: function() {
      ...
      if (this.$isPreview == true) {
        ...
        // @see http://github.com/toopay/bootstrap-markdown/issues/170
        return this;
      }
      ...
      [{
        ...
        data: [{
          ...
          callback: function(e){
            ...
            var urlRegex = new RegExp('^((http|http)://|(mailto:)|(//))[a-z0-9]', 'i');
          ...
          callback: function(e){
            ...
            var urlRegex = new RegExp('^((http|http)://|(//))[a-z0-9]', 'i');
            if (link !== null && link !== '' && link !== 'http://' && urlRegex.test(link)) {
              var sanitizedLink = $('<div>'+link+'</div>').text();
