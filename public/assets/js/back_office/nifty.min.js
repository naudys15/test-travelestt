...
! function (n) {
    ...
    n(document).ready(function () {
        ...
        n(document).on("show.bs.dropdown", ".dropdown", function () {
        ...
        i.length && i.nanoScroller({
            preventPageScrolling: !0
        }), n.niftyNav("bind"), n.niftyAside("bind");
        var o, s = n("#container");
        n("body").on("touchend", function (a) {
            ...
            n(a.target).hasClass("search-container") && n(a.target).collapse("hide"), s.hasClass("mainnav-in") && (s.hasClass("manual-nav-toggle") || 0 != n(a.target).closest("#mainnav-menu-wrap").length || 0 != n(a.target).closest(".mainnav-toggle").length || n.niftyNav("toggle")), s.hasClass("aside-in") && s.hasClass("aside-float") && (s.hasClass("manual-aside-toggle") || 0 != n(a.target).closest("#aside-container").length || 0 != n(a.target).closest(".aside-toggle").length || n.niftyAside("toggleHideShow"))
    ...
    n.fn.niftyMega = function (a) {
        ...
        a = n(".mega-dropdown"), a.length && (a.niftyMega(), n("body").on("clickortap toggle.sidebar click", function (e) {
            a.hasClass("open") && (n(e.target).closest(".mega-dropdown").length || (a.removeClass("open"), i(a.find(".mega-dropdown-menu"))))
        }))
    })
}(jQuery), ! function (n) {
    "use strict";
    ...
    n.niftyNoty = function (f) {
        var u, v = {
            ...
            m = function () {
                var n = "";
                return f && f.icon && (n = '<div class="media-left alert-icon"><i class="' + g.icon + '"></i></div>'), n
            },
            h = function () {
                var n = g.closeBtn ? '<button class="close" type="button"><i class="pci-cross pci-circle"></i></button>' : "",
                    a = '<div class="alert alert-' + g.type + '" role="alert">' + n + '<div class="media">';
                return g.html ? a + g.html + "</div></div>" : a + m() + '<div class="media-body"><h4 class="alert-title">' + g.title + '</h4><p class="alert-message">' + g.message + "</p></div></div>"
            }(),
            C = function () {
                return g.onHide(), "floating" === g.container && g.floating.animationOut && (p.removeClass(g.floating.animationIn).addClass(g.floating.animationOut), d || (g.onHidden(), p.remove())), p.removeClass("in").on("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd", function (n) {
                    "max-height" == n.originalEvent.propertyName && (g.onHidden(), p.remove())
                }), clearInterval(u), null
            },
            y = function (a) {
                n("body, html").animate({
                    scrollTop: a
        ...
        (function () {
            if (g.onShow(), "page" === g.container) a || (a = n('<div id="page-alert"></div>'), i && i.length || (i = n("#content-container")), i.prepend(a)), e = a, g.focus && y(0);
            else if ("floating" === g.container) {
                if (!r[g.floating.position]) {
                    r[g.floating.position] = n('<div id="floating-' + g.floating.position + '"></div>'), t || (t = n("#container"));
                    var d, f = g.floating.position.split("-")[0];
                    if ("top" == f) o || (o = n('<div id="floating-top-container" class="floating-container"></div>'), t.append(o)), d = o;
                    else if ("center" == f) s || (s = n('<div id="floating-center-container" class="floating-container"></div>'), t.append(s)), d = s;
                    else {
                        if ("bottom" != f) throw new Error('Unknown position ""' + g.floating.position + '""');
                        l || (l = n('<div id="floating-bottom-container" class="floating-container"></div>'), t.append(l)), d = l
                    }
                    d.append(r[g.floating.position])
                }
                e = r[g.floating.position], g.floating.animationIn && p.addClass("animated " + g.floating.animationIn), g.focus = !1
            } else {
                var u = n(g.container),
                    v = u.children(".panel-alert"),
                    m = u.children(".panel-heading");
                if (!u.length) return c = !1, !1;
                v.length ? e = v : (e = n('<div class="panel-alert"></div>'), m.length ? m.after(e) : u.prepend(e)), g.focus && y(u.offset().top - 30)
            }
            return c = !0, !1
        })();
        if (c) {
            if (e.append(p.html(h)), p.find('[data-dismiss="noty"]').one("click", C), g.closeBtn && p.find(".close").one("click", C), g.timer > 0 && (u = setInterval(C, g.timer)), !g.focus) var b = setInterval(function () {
                p.addClass("in"), clearInterval(b)
            }, 200);
            p.one("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd animationend webkitAnimationEnd oAnimationEnd MSAnimationEnd", function (n) {
                "max-height" != n.originalEvent.propertyName && "animationend" != n.type || !c || (g.onShown(), c = !1)
            })
        }
    }
}(jQuery), ! function (n) {
    ...
    var a = null,
        ...
        g = function () {
            ...
            t.each(function () {
                var o = n(this),
                    ...
                    u = null,
                    v = null,
                    g = (o.outerHeight() - o.height() / 4, function () {
                ...
                n("#mainnav-menu-wrap > .nano").on("update", function () {
                    ...
                    content: function () {
                        var a;
                        return g ? (a = n('<div class="sub-menu"></div>'), l.addClass("pop-in").wrap('<div class="nano-content"></div>').parent().appendTo(a)) : r.length ? (a = n('<div class="sidebar-widget-popover"></div>'), r.wrap('<div class="nano-content"></div>').parent().appendTo(a)) : a = '<span class="single-content">' + s.html() + "</span>", a
                    },
                    ...
                    if (!d) {
                        ...
                        if (f = d.find(".popover-title"), u = d.children(".popover-content"), !g && 0 == r.length) return;
                    ...
                    u.find(".nano-content").children().css("height", ""), t > l ? (f.length && !f.is(":visible") && (s = Math.round(0 - .5 * s)), t -= 5, u.css({
                        ...
                        preventPageScrolling: !0
                    }), m(u.find(".nano"))) : (!e.hasClass("navbar-fixed") && i.hasClass("affix-top") && (l -= 50), c > l ? ((e.hasClass("navbar-fixed") || i.hasClass("affix-top")) && (l -= s + 5), l -= 5, u.css({
                        top: s + "px",
                        bottom: "",
                        height: l
                    }).children().addClass("nano").css({
                        ...
                        preventPageScrolling: !0
                    }), m(u.find(".nano"))) : (f.length && !f.is(":visible") && (s = Math.round(0 - .5 * s)), u.css({
                        top: s + "px",
                        bottom: "",
                        height: "auto"
                    ...
                    o.removeClass("hover"), g ? l.removeAttr("style").appendTo(o.parent()) : r.length && r.appendTo(c), clearInterval(a)
                }).on("click", function () {
        ...
        C = function () {
            ...
            }), "collapse" == r || e.hasClass("mainnav-sm") ? (e.removeClass("mainnav-in mainnav-out mainnav-lg"), c || g()) : c && p(), s = n("#mainnav").height(), r = !1, null
        },
        y = {
            toggle: function () {
                e.hasClass("push") ? n.niftyNav("pushToggle") : e.hasClass("slide") ? n.niftyNav("slideToggle") : e.hasClass("reveal") ? n.niftyNav("revealToggle") : n.niftyNav("colExpToggle")
            },
            ...
            bind: function () {
                ...
                a = n('#mainnav-menu > li > a, #mainnav-menu-wrap .mainnav-widget a[data-toggle="menu-widget"]'), e = n("#container"), t = e.children(".boxed"), i = n("#mainnav-container"), s = n("#mainnav").height(), e.append('<div class="mainnav-backdrop"></div>');
                var r = null;
                ...
                c.length && c.on("click", function (a) {
                    a.preventDefault(), a.stopPropagation(), n("body").trigger("toggle.sidebar"), y.toggle()
                });
                try {
                    o.metisMenu({
                        toggle: !0
        ...
        r = function () {
            if (e = n("#aside-container"), e.length) {
                ...
                i.length && i.on("click", function (a) {
                    a.preventDefault(), a.stopPropagation(), n(this).parent("li").toggleClass("open"), n.niftyAside("toggleHideShow"), n("body").trigger("toggle.sidebar")
                })
            }
        };
