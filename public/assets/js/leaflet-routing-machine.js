	...
	module.exports = L.Class.extend({
		...
		_open: function() {
			...
			if (!this._container.parentElement) {
				// See notes section under http://developer.mozilla.org/en-US/docs/Web/API/Window/scrollX
...
/* 
   ...
   Instead, we rely on the module osrm-text-instructions (http://github.com/Project-OSRM/osrm-text-instructions/).
...
(function() {
	...
	module.exports = OSRMv1.extend({
		options: {
			serviceUrl: 'http://api.mapbox.com/directions/v5',
		...
		initialize: function(options) {
			...
			if (!this.options.suppressDemoServerWarning &&
				...
				console.warn('You are using OSRM\'s demo server. ' +
					...
					'http://github.com/Project-OSRM/osrm-backend/wiki/Api-usage-policy\n\n' +
